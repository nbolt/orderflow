    ...
    <div id='trunk-config'>
      ...
      <div className='foot'>
        <ul className='links'>
          ...
          <li className={this.continueClass()}><a href='javascript:void(0)' onClick={this.context.nav.bind(null, 'continue', this.props.route.path)}>{this.context.continueText('trunk_config')}</a></li>
        </ul>
      </div>
    </div>
